                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-shrink-0">
                            <button
                                ...
                                :class="type === 'success' ? 'text-green-500 hover:text-green-600 focus:ring-green-500' : type === 'error' ? 'text-red-500 hover:text-red-600 focus:ring-red-500' : 'text-blue-500 hover:text-blue-600 focus:ring-blue-500'"
                            >
