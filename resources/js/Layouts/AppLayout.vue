...
const navLinks = [
    ...
    { name: 'Strategy', href: '/strategies', key: 'strategy', icon: 'light-bulb' },
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                <template v-for="link in navLinks" :key="link.key">
                    ...
                    >
                        ...
                        <!-- Light Bulb icon -->
                        <svg v-else-if="link.icon === 'light-bulb'" class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
