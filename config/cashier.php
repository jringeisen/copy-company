...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This is the model that will be used as the billable entity for Cashier.
    | In this application, subscriptions are at the Account level rather than
    | individual users, so all brands within an account share one subscription.
    |
    */
