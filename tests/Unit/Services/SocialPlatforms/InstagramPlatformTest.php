...
test('it returns correct identifier', function () {
    expect($this->platform->getIdentifier())->toBe('instagram');
});

test('it returns correct display name', function () {
    expect($this->platform->getDisplayName())->toBe('Instagram');
});
